...
- **Privacy Policy v2.0 — 2026-05-11.** Full rewrite to a 17-section structure: separate 5a/5b data-collection tables (direct vs automatic), expanded third-party list (Supabase, postcodes.io, Anthropic, Plant.id, Mapbox, PostHog, Sentry, Resend, Apple, Google — Vercel / Expo / Google Play row dropped), new Service area (UK-only), Age (13+ with 13–17 guardian rule), Plant lifecycle and moments data, Wildlife and biodiversity data, ICO complaint section. Entity name switched from "Gardn Labs Ltd" to "Gardn Labs Limited" in the new copy. Stage 1 consent (Anonymised aggregate use) defaults to **on**, with the assumption that counsel will confirm opt-in-by-default is defensible for district-aggregated phenology observations under UK GDPR. **Not yet solicitor-signed** — this is the user-authored next version pending legal review.
- **Terms of Service v1.0 (draft) — 2026-05-11.** Drop-in via the `privacy.md` pattern: holding `src/pages/terms.astro` deleted, `src/pages/terms.md` created with 16 sections covering acceptance, eligibility (UK + 13+), accounts, subscription/billing (Free vs Premium £5.99/mo or £49.99/yr, 14-day trial, Apple-only billing), acceptable use, UGC, moderation, AI disclaimer, care guidance disclaimer, IP, limitation of liability, termination, Apple App Store boilerplate (Apple as third-party beneficiary), governing law (England & Wales). Section 11 carries an inline note flagging Consumer Rights Act 2015 / UCTA 1977 review. Footer reads *"Draft for legal review"* — **not solicitor-signed.**
...
Terms is now live at `src/pages/terms.md` (v1.0 draft, 2026-05-11). When solicitor sign-off lands: paste the signed text into the body of `terms.md`, bump the version line + "Last updated" date, remove the *"Draft for legal review"* suffix and the inline section-11 review note, and update the phase-status row above. Same registered office as `privacy.md` — **Gardn Labs Limited, 124-128 City Road, London, EC1V 2NX** (Company No. 17195491).
...
- Privacy v2.0 (2026-05-11) and Terms v1.0 (2026-05-11) are both live but **not yet solicitor-signed** — user-authored drafts pending legal review. Privacy v1.0 (2026-05-08) was solicitor-signed; the v2.0 rewrite supersedes it pending sign-off on the new text. Treat both as the current published copy but flag any further substantive edits as needing legal sign-off before push.
