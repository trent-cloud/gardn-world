...
Also write a dated archive copy to `mcleod/docs/sessions/YYYY-MM-DD.md` so the full session history is preserved off the read path.

## Step 3 — update MCLEOD_STATE.md in this repo

Edit `mcleod/MCLEOD_STATE.md` at this project's root (copy from `mcleod/shared/MCLEOD_STATE.template.md`
